                    ...
                    <tbody>
                        ...
                        <?php foreach ($subMenu as $sm) : ?>
                            <tr>
                                ...
                                <td><?= $sm['is_active']; ?></td>
                                <td>
                                    <a href="" class="badge badge-success" data-toggle="modal" data-target="#editSubMenuModal<?= $sm['id']; ?>">Ubah</a>
                                    ...
                                    <a href="" data-toggle="modal" data-target="#hapusSubMenuModal<?= $sm['id']; ?>" class="badge badge-danger">Hapus</a>
