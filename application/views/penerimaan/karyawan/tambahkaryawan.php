        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4">
                ...
                <a href="#collapseCardExample3" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Pelamar</h6>
                </a>
                <!-- Card Content - Collapse -->
                <div class="collapse show" id="collapseCardExample3">
                    <div class="card-body">

                        <?= form_open_multipart('penerimaan/tambahkaryawan'); ?>


                        <div class="form-group row">
                            <label for="nama_karyawan" class="col-sm-3 col-form-label">Nama Pelamar</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="nama_karyawan" name="nama_karyawan" placeholder="Masukkan Nama Pelamar" value="<?= set_value('nama_karyawan'); ?>">
                        ...
                        <div class="form-group row date">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id='datetimepicker2' name="periode" required>
                            </div>
                        </div>
