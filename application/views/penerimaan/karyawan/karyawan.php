            ...
            <div class="card shadow mb-4">
                ...
                <div class="collapse show" id="collapseCardExample3">
                    ...
                    alert-danger" role="alert">', '</div>'); ?>
                        ...
                        <a href="<?= base_url('penerimaan/tambahkaryawan'); ?>" class="btn btn-secondary mb-3">Tambah</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($karyawan as $k) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url() ?>penerimaan/editkaryawan/<?= $k['id_karyawan']; ?>" class="badge badge-success">Ubah</a>
                                                <a href="" class="badge badge-danger" data-toggle="modal" data-target="#hapusKaryawanModal<?= $k['id_karyawan']; ?>">Hapus</a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Hapus Pelamar</h5>
                                                                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">×</span>
                                                                </button>
                                                            </div>
                                                            <form action="<?= base_url('penerimaan/hapuskaryawan'); ?>" method="post">
