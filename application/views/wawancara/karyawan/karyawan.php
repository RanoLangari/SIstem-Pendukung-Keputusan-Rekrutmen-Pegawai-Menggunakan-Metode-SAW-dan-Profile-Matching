            ...
            <div class="card shadow mb-4">
                ...
                <div class="collapse show" id="collapseCardExample3">
                    ...
                    alert-danger" role="alert">', '</div>'); ?>
                        ...
                        <a href="<?= base_url('spk/tambahkaryawan'); ?>" class="btn btn-secondary mb-3">Tambah</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($karyawan as $k) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url() ?>spk/editkaryawan/<?= $k['id_karyawan']; ?>" class="badge badge-success">Ubah</a>
