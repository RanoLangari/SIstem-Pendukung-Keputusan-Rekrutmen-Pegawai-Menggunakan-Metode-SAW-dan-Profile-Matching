            ...
            <div class="card shadow mb-4">
                ...
                <div class="collapse show" id="collapseCardExample3">
                    ...
                    alert-danger" role="alert">', '</div>'); ?>
                        ...
                        <a href="<?= base_url('wawancara/tambahkriteria'); ?>" class="btn btn-secondary mb-3">Tambah</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($kriteria as $k) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url() ?>wawancara/editkriteria/<?= $k['id_kriteria']; ?>" class="badge badge-success">Ubah</a>
                                                ...
                                                <div class="modal fade" id="hapusKriteriaModal<?= $k['id_kriteria']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="<?= base_url('wawancara/hapuskriteria'); ?>" method="post">
